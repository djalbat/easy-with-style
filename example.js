(() => {
  ...
  // lib/example/heading.js
  var require_heading = __commonJS((exports) => {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    exports.default = void 0;
    var _index2 = _interopRequireDefault2(require_lib6());
    function _interopRequireDefault2(obj) {
      return obj && obj.__esModule ? obj : {
        default: obj
      };
    ...
    var Heading = _index2.default.h1(_templateObject());
    var _default = Heading;
    exports.default = _default;
  });

  // lib/example/div/rows.js
  var require_rows = __commonJS((exports) => {
    ...
    var _default = _index2.default(RowsDiv)(_templateObject());
    exports.default = _default;
  });

  // lib/example/div/column.js
  var require_column = __commonJS((exports) => {
    ...
    var _default = _index2.default(ColumnDiv)(_templateObject());
    exports.default = _default;
  });

  // lib/example/div/columns.js
  var require_columns = __commonJS((exports) => {
    ...
    var _default = _index2.default(ColumnsDiv)(_templateObject());
    exports.default = _default;
  });
  ...
  var require_subHeading = __commonJS((exports) => {
    ...
    var SubHeading = _index2.default.h2(_templateObject());
  ...
  var require_sizeable = __commonJS((exports) => {
    ...
    var _default = _index2.default(SizeableDiv)(_templateObject());
    exports.default = _default;
  });
  ...
  var require_textarea2 = __commonJS((exports) => {
    ...
    var _default = _index2.default(_easy2.Textarea)(_templateObject());
    exports.default = _default;
  });
  ...
  // lib/example/div/splitter/vertical.js
  var require_vertical = __commonJS((exports) => {
    ...
    var _index2 = _interopRequireDefault2(require_lib6());
    var _easy2 = require_lib();
    var _cursor = _interopRequireDefault2(require_cursor());
    function _assertThisInitialized(self) {
      if (self === void 0) {
        throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
      }
    ...
    var VerticalSplitterDiv = function(Element1) {
      _inherits(VerticalSplitterDiv2, _easy2.Element);
      function VerticalSplitterDiv2() {
        _classCallCheck(this, VerticalSplitterDiv2);
        return _possibleConstructorReturn(this, _getPrototypeOf(VerticalSplitterDiv2).apply(this, arguments));
      }
      _createClass(VerticalSplitterDiv2, [
        {
          key: "mouseUpHandler",
        ...
        },
        {
          ...
          value: function initialise() {
            ...
            _easy2.window.onMouseUp(mouseUpHandler);
            _easy2.window.onMouseMove(mouseMoveHandler);
          }
        }
      ], [
        {
          key: "fromClass",
          value: function fromClass(Class, properties) {
            var verticalSplitter = _easy2.Element.fromClass(Class, properties);
            verticalSplitter.initialise();
            return verticalSplitter;
          }
        }
      ]);
      return VerticalSplitterDiv2;
    ...
    var _default = _index2.default(VerticalSplitterDiv)(_templateObject());
    exports.default = _default;
  });

  // lib/example/textarea/lexicalEntries.js
  var require_lexicalEntries = __commonJS((exports) => {
    ...
    var LexicalEntriesTextarea = function(Textarea) {
      ...
      _createClass(LexicalEntriesTextarea2, [
        {
      ...
      return LexicalEntriesTextarea2;
    }(_textarea.default);
  ...
  var require_view = __commonJS((exports) => {
    ...
    var _lexicalEntries = _interopRequireDefault2(require_lexicalEntries());
    function _assertThisInitialized(self) {
      if (self === void 0) {
        throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
      }
    ...
    var View = function(Element1) {
      ...
      _createClass(View2, [
      ...
      ], [
        {
          key: "fromClass",
          value: function fromClass(Class, properties) {
            var view = _easy2.Element.fromClass(Class, properties);
            view.initialise();
            return view;
          }
        }
  ...
  // lib/example.js
  "use strict";
  var _index = _interopRequireDefault(require_lib6());
